...
export function VirtualGrid<T>({ items, renderItem, columnCount = 3, gap = 16, overscan = 5 }: VirtualGridProps<T>) {
  ...
  const rowHeight = 200 + gap // Adjust this based on your card height
